...
import { GiteaUser, GiteaRepository } from '@/lib/gitea.types'
...
interface SyncState {
  ...
  // Gitea 相关状态
  giteaUserInfo?: GiteaUser
  setGiteaUserInfo: (giteaUserInfo?: GiteaUser) => void

  giteaSyncRepoState: SyncStateEnum
  setGiteaSyncRepoState: (giteaSyncRepoState: SyncStateEnum) => void
  giteaSyncRepoInfo?: GiteaRepository
  setGiteaSyncRepoInfo: (giteaSyncRepoInfo?: GiteaRepository) => void
}
